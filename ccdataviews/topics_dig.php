...
[/meta]
*/
function topics_dig_dataview() 
{
    /*
        so 'topic_format' was missing from the topics dataview and it was
        being set to BB format for every json query. I'm too chicken to
        add the field into the original topics dataview because I can't
        gauge what parts of the ccmixter rely on that behavior. 
    */
    $urlp = ccl('people') . '/';
    $turl = ccl('thread') . '/';
