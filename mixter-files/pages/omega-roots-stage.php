...
[meta]
     ...
     desc = _('Omega Roots Stage')
     page_title = _('Omega Roots Stage')
      content_feed = 0
      content_page_box = 0
...
cc_query_fmt('f=embed&t=ccskins/shared/pages/content_page.tpl&sort=date&ord=desc&type=Omega Roots Stage&limit=&paging=off&topic=' . $topic );
// no paging 
//  
?>
