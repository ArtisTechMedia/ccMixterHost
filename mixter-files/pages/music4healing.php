...
[meta]
     ...
     desc = _('Music4Healing')
     page_title = _('Music4Healing')
      content_feed = 0
      content_page_box = 0
...
cc_query_fmt('f=embed&t=ccskins/shared/pages/content_page.tpl&sort=date&ord=desc&type=Music for Healing&limit=&paging=on&topic=' . $topic );
cc_add_content_paging_links($A,'Music for Healing',$topic,'desc','music4healing', '');
