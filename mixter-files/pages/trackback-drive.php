...
[meta]
     ...
     desc = _('Trackback Drive')
     page_title = _('Trackback Drive')
      content_feed = 0
      content_page_box = 0
...
cc_query_fmt('f=embed&t=ccskins/shared/pages/content_page.tpl&sort=date&ord=desc&type=Trackback Drive&limit=&paging=on&topic=' . $topic );
cc_add_content_paging_links($A,'Trackback Drive',$topic,'desc','trackback-drive', '');
