...
[meta]
     ...
     desc = _('Previous Events')
     page_title = _('Previous Events')
      content_feed = 0
      content_page_box = 0
...
cc_query_fmt('f=embed&t=ccskins/shared/pages/content_page.tpl&sort=date&ord=desc&type=Previous Events&limit=&paging=on&topic=' . $topic );
cc_add_content_paging_links($A,'Previous Events',$topic,'desc','previous-events', '');
